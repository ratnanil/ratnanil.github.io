...
The data from gis.stackexchange.com shows that both ArcGIS and QGIS have grown in popularity since 2011. ArcGIS has hit a peak aroudn 2014, 2015 with the release of ArcGIS pro and has since been on a decline. The number of QGIS questions have overtaken those of ArcGIS end of 2016 and QGIS has been dominating the portal ever since. 
...
```{r}
#| code-summary: Preparing Google Trend data
